...
3. Apply the module-specific rules: Inspect projects and fixtures; prefer accessible locators; set up deterministic data; avoid arbitrary sleeps; keep tests independent.
