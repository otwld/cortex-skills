...
This graph is the canonical dependency map for skills in this workspace. Inline `Cross-References` sections in each `SKILL.md` must match this table. Routing signal rules live in `references/skill-cascade.md`.
