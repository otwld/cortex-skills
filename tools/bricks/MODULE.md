...
3. Apply the module-specific rules: Inspect Bricks status; identify workflow branch; use Bricks commands instead of manual copies; protect consumer edits; run doctor or diff checks.
