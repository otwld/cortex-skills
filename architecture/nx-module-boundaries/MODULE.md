...
description: Internal Cortex module applied when working in an Nx workspace and adding, moving, or reviewing projects, tags, dependencies, or module-boundary rules.
---
...
3. Apply the module-specific rules: Inspect tags and graph; keep dependency direction valid; fix ownership instead of weakening rules; update tags only when responsibility changes.
