...
3. Apply the skill-specific rules: Inventory consumers; separate stable behavior from coincidental shape; choose owner before API; preserve dependency direction.
