...
description: Use when finding shallow modules, deepening candidates, test seams, or architecture improvements that should increase leverage and locality.
---

# Output Marker

Display:
using skill: architecture-deepening-review
...
3. Apply the skill-specific rules: Use the architecture vocabulary exactly; apply the deletion test; classify dependencies; identify the interface that tests should cross.
