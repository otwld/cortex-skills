...
3. Name the touched documentation surfaces: exported symbols, framework-bound
   inputs, commands, routes, config, DTOs, schemas, examples, stories, fixtures,
   generated docs, or dense private logic.
