...
description: Internal Cortex module applied when producing examples, sample code, DTOs, API payloads, Storybook data, docs snippets, tests, or illustrative data.
---

# Output Marker

Display:
using module: example-universe-enforcer
