...
3. Apply the skill-specific rules: Prefer composition over nested subscriptions; choose flattening operators by concurrency semantics; justify subjects and multicasting.
