...
- Apply `storybook-conventions` for the strict `<feature>/<technology>/<subject...>` title format, MDX identity, duplicate-title handling, source-mirror docs, and deterministic story data.
