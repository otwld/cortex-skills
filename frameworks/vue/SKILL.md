...
3. Apply the skill-specific rules: Use local Vue style; type props and emits; prefer computed derived state; extract composables only for real reuse; document slots.
