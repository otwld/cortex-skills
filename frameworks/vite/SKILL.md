...
3. Apply the skill-specific rules: Keep aliases aligned with public entry points; externalize peers for libraries; preserve source maps intentionally; document plugin order when important.
