...
3. Apply the skill-specific rules: Separate facts from preferences; ask only decision-changing questions; recommend defaults; record non-goals and success criteria.
