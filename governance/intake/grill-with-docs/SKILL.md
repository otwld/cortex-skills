...
description: Use when stress-testing a plan against project vocabulary, documented decisions, domain rules, or when a deep questioning session should update glossary and ADR artifacts.
---

# Output Marker

Display:
using skill: grill-with-docs
...
3. Apply the skill-specific rules: Read memory first; explore facts instead of asking; ask one decision-changing question at a time; update glossary terms inline; offer ADRs sparingly.
