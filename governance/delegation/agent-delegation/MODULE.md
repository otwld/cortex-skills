...
description: Internal Cortex module applied when independent tasks, investigations, or review passes can be delegated without shared state or sequential dependencies.
---
...
3. Apply the module-specific rules: Separate independent tasks; choose exploration, implementation, or review; provide constraints; inspect returned evidence before integrating.
