...
description: Internal Cortex module applied before behavior changes, bug fixes, or refactors where tests can prove the intended behavior or regression.
---
...
3. Apply the module-specific rules: Name behavior; choose highest meaningful seam; write one failing test; implement minimally; refactor only when green; document exceptions.
