---
name: plan-execution
description: Internal Cortex module applied when executing a written implementation plan task-by-task with validation checkpoints and no remaining design decisions.
---
...
3. Apply the module-specific rules: Derive requirements; check workspace state; execute tasks in order; apply test-first and docs gates; run named validation; surface plan drift.
