...
3. Apply the skill-specific rules: Derive requirements; check workspace state; execute tasks in order; apply test-first and docs gates; run named validation; surface plan drift.
...
If the plan says rewrite all skills and validator tests, do not stop after adding
references.
